        ...
        <Tabs defaultValue="typography">
          ...
          <TabsPanel value="misc">
            <Flow className="mt-10">
              ...
              <DemoSection label="Tooltip — badge descriptions">
                <Flow>
                  <Text>
                    Hover or focus a badge to read its description. Press Escape to dismiss.
                  </Text>
                  <AccountBadgeList achievements={{ Founder: 1, CommittedPlayer: 25 }} />
                </Flow>
              </DemoSection>
              ...
              <DemoSection label="Character profile">
                <Flow>
                  ...
                  <Text>
                    ...
                    pressed into close quarters she switches to twin short blades, a technique
                    drilled into her by an old mercenary captain whose name she will not share.
                  </Text>
