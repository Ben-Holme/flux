...
const baseOptions: Options = {
  ...
  renderNode: {
    ...
    [BLOCKS.HEADING_4]: (_node, children) => <Heading level="h4">{children}</Heading>,
    [BLOCKS.HEADING_5]: (_node, children) => <Heading level="h5">{children}</Heading>,
    [BLOCKS.HEADING_6]: (_node, children) => <Heading level="h6">{children}</Heading>,
