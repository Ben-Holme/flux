    ...
    <div ref={sectionRef} className="relative overflow-hidden">
      {scene === 1 && (
        <>
          ...
          <div className="relative mx-auto box-content flex min-h-screen max-w-[1200px] items-center gap-24 px-6 max-[768px]:min-h-0 max-[768px]:flex-col max-[768px]:px-6 max-[768px]:pt-16 max-[768px]:pb-[330px] [&>div]:grow [&>div]:basis-0">
            <div className="z-2 max-[768px]:order-2 max-[768px]:w-full">
              ...
              {copy && <RichText largeH2s document={copy} />}
              {onShowLoreVideo && (
            ...
            {/* Spritfolk character */}
            <div className="relative after:absolute after:inset-0 after:scale-150 after:bg-[url(/img/paint.png)] after:bg-contain after:bg-center after:bg-no-repeat after:content-[''] max-[768px]:absolute max-[768px]:top-[-2%] max-[768px]:right-[-5%] max-[768px]:w-[60%] max-[768px]:after:scale-[1.3]">
              ...
              />
              <p className="absolute right-0 bottom-[100px] left-0 z-[3] mt-0 text-center text-[0.5rem] tracking-[0.1em] text-white/40 uppercase max-[768px]:hidden">
                Create your spritfolk bloodline
              </p>
            </div>
          </div>

          <div className="absolute bottom-[30px] left-[30px] z-[2] flex items-center text-xs tracking-[0.1em] text-white/40 uppercase max-[768px]:right-0 max-[768px]:bottom-6 max-[768px]:left-0 max-[768px]:justify-center max-[768px]:text-[0.65rem] [&_svg]:mr-2 [&_svg]:block [&_svg]:w-2 max-[768px]:[&_svg]:mr-[6px] max-[768px]:[&_svg]:w-[6px]">
            {CAPTION_ICON}
            Elder Forest
          </div>
        </>
      ...
      {scene === 2 && (
        <>
          ...
          <div className="relative z-[2] flex min-h-screen flex-col items-start justify-center gap-12 max-[768px]:block max-[768px]:min-h-0">
            <div className="mx-auto mt-20 box-border w-full max-w-[1200px] basis-0 pr-[600px] max-[768px]:m-0 max-[768px]:mb-8 max-[768px]:px-6 max-[768px]:py-16">
              {preHeading && (
                <Eyebrow className="mb-6" deco>
                  {preHeading}
                </Eyebrow>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
              {copy && (
                <div className="mb-8 w-full max-w-md">
                  <RichText largeH2s document={copy} />
                </div>
              )}
              <LeadForm />
            </div>
